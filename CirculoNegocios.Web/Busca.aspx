            ...
            <ul class="breadcrumb">
                <li>
                    <asp:LinkButton ID="lnkCategoriaBusca" runat="server">
                        <asp:Literal ID="litCategoriaBusca" runat="server" Text=""></asp:Literal>
                    </asp:LinkButton><span class="divider"></span></li>
                <li>
                    <asp:LinkButton ID="lnkEstadoBusca" runat="server">
                        <asp:Literal ID="litEstadoBusca" runat="server" Text=""></asp:Literal>
                    </asp:LinkButton><span class="divider"></span></li>
                <li>
            ...
            <asp:Repeater ID="rptResultado" runat="server">
                ...
                <ItemTemplate>
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p>
                                <a class="btn" href='<%#string.Format(@"DetalheCliente.aspx?idCliente={0}", DataBinder.Eval(Container.DataItem,"id").ToString()) %>'>
                                    Saiba mais »</a></p>
                        </div>
                    </div>
                    <br />
                ...
                <FooterTemplate>
                    <div>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:LinkButton
                            ID="lnkAnterior" runat="server" ToolTip="Anterior" OnClick="lnkAnterior_Click">Anterior</asp:LinkButton>
                        &nbsp;&nbsp;&nbsp;&nbsp;<asp:LinkButton ID="lnkProximo" runat="server" ToolTip="Próximo"
                            OnClick="lnkProximo_Click">Próximo</asp:LinkButton>
                    </div>
                </FooterTemplate>
            </asp:Repeater>
            <br />
